...
c
      ...
      open(12, file='add.out', form='unformatted')
      ...
      do 10 k=1,nz
         do 11 j=1,ny
           if(r4.eq.'r') then
             ...
             write(12) (x1*vel1(i)+x2*vel2(i),i=1,nx)
           else
             read(10,end=999) (veli1(i),i=1,nx)
             read(11,end=999) (veli2(i),i=1,nx)
             do 12 i=1,nx
12              veli(i)=nint(x1*veli1(i)+x2*veli2(i))
             write(12) (veli(i),i=1,nx)
           end if
11       continue
         nk=nk+1
10    continue
