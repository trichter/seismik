...
c     |               ********  R E G R I D 2  *****                 |
c     |                                                              |
c     |   Resample 2D inverse cell mode onto 2D forward node model   |
c     |                                                              |
...
c
c        11 -- output:  forward 2D data grid
c
c        35 -- input:  parameters describing size of forward 2D grid
c
c        36 -- input:  parameters describing size of inverse 2D grid
c
c
c     ----------------------------------------------------------------
c
